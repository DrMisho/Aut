        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="section-button d-flex mb-55">
                    <a href="grid-layout.html" class="btn btn--common btn--primary rt-button-animation-out">See More
                    ...
                    <div class="row g-0">
                        <div class="col-lg-4 col-md-6 blog-item__column mb-30">
                            <div class="blog-item blog-item--one">
                                <header class="blog-item__header mb-35">
                                    <a href="blog-details.html" class="blog-item__img_link">
                                        <img width="551" height="395" class="blog-item__img" src="theme/images/blog/blog-thumb-1.jpg"
                                             alt="Questions every Business" />
                                    </a>
                                    <a href="blog-details.html" class="blog-item__tags">Digital</a>
                                </header>
                                <div class="blog-item__article">
                                    <span class="blog-item__date">18 April, 2021</span>
                                    ...
                                    <ul class="blog-item__meta">
                                        <li class="blog-item__list">
                                            ...
                                            <span class="blog-item__list_name">By James Smith</span>
                                        </li>
                                        <li class="blog-item__list">
                                            <i class="far fa-comments"></i>
                                            <span class="blog-item__list_name">02 Comments</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 blog-item__column mb-30">
                            <div class="blog-item blog-item--two">
                                <header class="blog-item__header mb-35">
                                    <a href="blog-details.html" class="blog-item__img_link">
                                        <img width="551" height="395" class="blog-item__img" src="theme/images/blog/blog-thumb-2.jpg"
                                             alt="Questions every Business" />
                                    </a>
                                    <a href="blog-details.html" class="blog-item__tags">Quick Tips</a>
                                </header>
                                <div class="blog-item__article">
                                    ...
                                    <ul class="blog-item__meta">
                                        <li class="blog-item__list">
                                            <i class="far fa-user blog-item__list_icon"></i>
                                            <span class="blog-item__list_name">By Armaan Cullen</span>
                                        </li>
                                        <li class="blog-item__list">
                                            <i class="far fa-comments"></i>
                                            <span class="blog-item__list_name">05 Comments</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 blog-item__column mb-30">
                            <div class="blog-item blog-item--three">
                                <header class="blog-item__header mb-35">
                                    <a href="blog-details.html" class="blog-item__img_link">
                                        <img width="551" height="395" class="blog-item__img" src="theme/images/blog/blog-thumb-3.jpg"
                                             alt="Questions every Business" />
                                    </a>
                                    <a href="blog-details.html" class="blog-item__tags">Solution</a>
                                </header>
                                <div class="blog-item__article">
                                    ...
                                    <ul class="blog-item__meta">
                                        ...
                                        <li class="blog-item__list">
                                            <i class="far fa-comments"></i>
                                            <span class="blog-item__list_name">04 Comments</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
