                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-7 col-md-8">
                        <div class="slider-content">
                            <h2 id="ml12" class="section-heading__title_big" style="color: white;" data-animation="fadeInUp" data-delay=".6s">
                                You have got to really understand something about people in today’s world:
                            </h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-8">
                        <div class="slider-content text-end">
                            <h2 id="ml12" class="section-heading__title_big" style="color: white;" data-animation="fadeInUp" data-delay=".6s">
                                People want happy healthy, <br> homes for their FAMILIES,
                            </h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="slider__single slider__bg container-custom" data-bg-image="theme/images/slider/4.jpg">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-8">
                        <div class="slider-content">
                            <h2 id="ml12" class="section-heading__title_big text-center" style="color: white;" data-animation="fadeInUp" data-delay=".6s">
                                People want to fulfill their DREAMS in life.
                            </h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-6 col-lg-7 col-md-8">
                        <div class="slider-content">
                            <h2 id="ml12" class="section-heading__title_big" style="color: white;" data-animation="fadeInUp" data-delay=".6s">
                                You can CALL on IT whenever you NEED it, <br> so you can relax and enjoy life.
                            </h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="slider__single slider__bg container-custom" data-bg-image="theme/images/slider/7.jpg">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-8">
                        <div class="slider-content">
                            <h2 id="ml12" class="section-heading__title_big text-start" style="color: white;" data-animation="fadeInUp" data-delay=".6s">
                                While it is hard to be a PIONEER in the IT World <br> when the road had already been paved…
                                <br><br>
                            </h2>
                            <h2 id="ml12" class="section-heading__title_big text-start" style="color: white;" data-animation="fadeInUp" data-delay="5s"> It’s part of our NATURE to find a UNIQUE INNOVATIVE <br> ways to help people and CREATE
                                <br> a LASTING IMPRESSION in the IT world.
                            </h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-6 col-lg-7 col-md-8">
                        <div class="slider-content">
                            <h2 id="ml12" class="section-heading__title_big" style="color: white;" data-animation="fadeInUp" data-delay=".6s">
                                We provide SIMPLE, ADVANCED solutions to people <br> to REALIZE their dreams.
                            </h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="slider__single slider__bg container-custom" data-bg-image="theme/images/slider/9.jpg">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-8">
                        <div class="slider-content text-center">
                            <h1 id="ml12" class="section-heading__title_big" style="color: white;" data-animation="zoomIn" data-delay=".6s">
                                IT For People
                            </h1>
                        </div>
                    </div>
