                              ...
                              {{translate('confirm')}}
                                ...
                                <v-layout row wrap class=""  >
                                      ...
                                      <v-layout wrap row v-if="state == 'used'">
                                        ...
                                        <v-flex md12 sm12 xl12 xm12  v-if='msg.product_type'>
                                          
                                          <h2>
                                            {{'| '+translate('prodcut_type')}}
                                          </h2>
                                          <ul>
    ...
    export default {
        ...
        methods:{
            ...
            save(){
               ...
               this.$http.delete('api/attribute/groups/'+this.id).then((response) => {
                    this.hide();
                    this.$emit('saved');
         ...
         async showRelated(item){
                  ...
                  this.id = item.id;
                    ...
                    // this.$http.get('api/attribute/group-realated/'+this.id).then((response) => {
